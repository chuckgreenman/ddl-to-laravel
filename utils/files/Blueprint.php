...
class Blueprint
{
    ...
    public function toSql(Connection $connection, Grammar $grammar)
    {
        ...
        foreach ($this->commands as $command) {
            ...
            if (
                method_exists($grammar, $method) ||
                $grammar::hasMacro($method)
            ) {
                if (
                    !is_null(
    ...
    {
        return !is_null(
            collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return collect($this->getAddedColumns())
